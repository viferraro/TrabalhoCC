...
diretorio_pai = criar_diretorio_incrementado('resultadosResNet50', 'resNet50MNIST')
print(f'Diretório criado: {diretorio_pai}')

# Cria o diretório 'ResNetCarbon'
diretorio_carbon = criar_diretorio_incrementado(diretorio_pai, 'resNet50_carbono')
...
modelo = ResNet50().to(dispositivo)
print(modelo)
